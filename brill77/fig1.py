...
mycable = Cable()
# graphing objects objref g[3]
#mycable.myL = 1000
#mycable.geom() # avoid error prior to version 5.3 for too long cells
# h.load_file(1, "fig1.ses")
...
# # g[0].begin
# for varlen in [25, 50, 100, 200, 1000, 2000, 4000, 6000, 8000, 9000, 9500]:
# # for case(&varlen, 25, 50, 100, 200, 1000, 2000, 4000, 6000, 8000, 9000, 9500) {
#     g[0].plot(varlen)
#     # g[0].flush
